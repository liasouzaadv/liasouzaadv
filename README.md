...
⚖️ Bacharel em Direito | Background analítico aplicado a dados e negócio  
...
### 🔍 Sobre mim
Sou estudante de **Análise de Dados**, com foco em **análise exploratória, SQL e visualização de dados**.  
Tenho experiência prática em projetos que envolvem **limpeza, modelagem, análise e storytelling de dados**, sempre buscando transformar dados em **insights acionáveis para tomada de decisão**.

Meu background em Direito fortalece minha capacidade analítica, atenção a detalhes e visão crítica sobre dados, métricas e impacto no negócio.
